...
(defun max/evil-hook ()
  (dolist (mode '(custom-mode
    ...
    (let ((hook (intern (concat (symbol-name mode) "-hook"))))
      (add-hook hook (lambda () (evil-emacs-state))))))
...
(use-package visual-fill-column
  ...
  :hook (LaTeX-mode-hook . max/org-mode-visual-fill))
...
(setq julia-include-number-face t)
(setq julia-include-operators-face t)

;; Optional: REPL integration (nice to have)
