...
case ":$PATH:" in
    *:/home/maxwell/.juliaup/bin:*)
        ;;

    *)
        export PATH=/home/maxwell/.juliaup/bin${PATH:+:${PATH}}
        ;;
esac
# Tab completion for juliaup and julia channel selection
[ -f "/home/maxwell/.julia/juliaup/completions/bash.sh" ] && source "/home/maxwell/.julia/juliaup/completions/bash.sh"
